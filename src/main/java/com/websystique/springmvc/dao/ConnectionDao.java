...
public class ConnectionDao {
	...
	try {
		...
		// "jdbc:mysql://awsrds.cuaofirbrh2o.us-west-2.rds.amazonaws.com:3306/user","postgres","postgres123");
		//jdbc:postgresql://localhost/test?user=fred&password=secret
		"jdbc:postgresql://3.7.225.11:5432/user?user=postgres&password=postgres123");	
